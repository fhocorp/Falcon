...
<div id="submenu">
<A HREF="/cgi-bin/network/index.html">Configuration R&eacute;seau</A><A HREF="/cgi-bin/operateurs.html">Operateurs</A><A HREF="/cgi-bin/state/index.html">Etat</A><A HREF="/cgi-bin/reset.html">Red&eacute;marrage</A>
</div>
<div id="sidebar_left">
